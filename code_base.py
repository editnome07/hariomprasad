        ...
        for file in files:
            ...
            if any(file.endswith(ext) for ext in INCLUDE_EXTENSIONS):
                ...
                try:
                    ...
                    compiled_contents += f"Content: Error reading file ({str(e)})\n\n"
    return compiled_contents


if __name__ == "__main__":
    # Hardcoded repository path
    repo_path = r"E:\Websites\Hariom Portfolio"  # Your repository path
    code_files_content = extract_code_files(repo_path)
    output_file = os.path.join(repo_path, "project.txt")
    try:
