                ...
                {processSteps.map((step, index) => (
                    <div key={step.id} className="relative group">
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center">
                            <div className="w-16 h-16 rounded-full bg-secondary border border-border flex items-center justify-center mb-6 group-hover:border-primary group-hover:glow-crimson-subtle transition-all duration-300 hover:scale-110 transform">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="relative opacity-0 animate-slide-in-left lg:sticky lg:top-24">
              {/* IMAGE FRAME UPDATED: Changed max-w-md to max-w-sm to make it smaller height-wise */}
              <div className="relative aspect-[4/5] max-w-sm mx-auto group">
                <div className="absolute -inset-4 bg-gradient-to-br from-primary/30 to-transparent rounded-2xl blur-2xl group-hover:blur-3xl transition-all duration-500" />
